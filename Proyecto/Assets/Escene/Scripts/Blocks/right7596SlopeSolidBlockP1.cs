...
public class right7596SlopeSolidBlockP1 : solidSlopeBlock
{
    public right7596SlopeSolidBlockP1() : base(4, 0, 8, 75.96f)
    {
        color = new Color32(224, 0, 0, 128);
        blockName = "Solid Block Right Slope 75.96 degrees Part 1";
